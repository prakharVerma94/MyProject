...
import static my.custom.pack.Utils.HEX;
...
public class MnemonicCode {
    ...
    private static final String BIP39_ENGLISH_RESOURCE_NAME = "english.txt";
    		
    //		"/src/main/webapp/english.txt";
    ...
    public static InputStream openDefaultWords() throws IOException {
    	...
    	/*try {
		System.out.println(	"==========="+Class.forName("my.custom.pack.MnemonicCode").getClassLoader().getResource(BIP39_ENGLISH_RESOURCE_NAME));
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}*/
    	
    	
    //	System.out.println("insid ethe code : "+BIP39_ENGLISH_RESOURCE_NAME);
        InputStream stream = MnemonicCode.class.getResourceAsStream(BIP39_ENGLISH_RESOURCE_NAME);
   //     System.out.println("ccccccc "+stream);
        if (stream == null)
...
//    [south, identify, begin, build, agree, margin, since, hello, empty, segment, devote, reward, amused, close, fancy, empty, mind, depart, crime, tomato, december, gas, major, nerve, basic, region, usage, wrist, blame, scissors, cereal, tobacco, clock, square, cotton, rent, worth, ozone, pave, crouch, purpose, area, deer, size, breeze, lunch, nerve, soft]
